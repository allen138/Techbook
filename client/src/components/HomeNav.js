    ...
    return (
      <div>
        <nav className="navbar fixed-top navbar-dark bg-dark">
          <Wrapper>
            <Link to="/home" className="navbar-brand homeLink">
              <img
                src="/techLogo.jpg"
                width="30"
                height="30"
              ...
              />
              <span className="logoTitle"> Techbook</span>
            </Link>
            <div className="dropdown projectsDropdown">
              <button className="dropBtn">Projects</button>
              <div className="dropdown-content">
                <Link to="/all-projects" className="dropLinks">
                  All Projects
                </Link>
                <Link to="/projects" className="dropLinks">
                  Your Projects
                </Link>
              </div>
            </div>
            <Link to="/favorites" className="navbar-item favoritesLink">
              Favorites
            </Link>
            <div className="search-container">
              <h6 className="searchBar-title">
            ...
            <div className="dropdown avatarDropdown">
              <button
                ...
                aria-expanded="false"
              >
                <img id="avatar" src={avatar} alt={firstName} />
              </button>
              <div
